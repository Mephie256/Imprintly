...
export const metadata: Metadata = {
  ...
  description: 'Create stunning text-behind-subject effects with AI-powered background removal. Upload any image and place text behind the subject for professional, eye-catching visuals.',
  keywords: 'text behind effect, background removal, AI image editing, text overlay, graphic design, photo editing',
  ...
  openGraph: {
    title: 'Imprintly - AI-Powered Text Behind Effect Creator',
    description: 'Create stunning text-behind-subject effects with AI-powered background removal.',
  ...
  icons: {
    icon: [
      { url: 'https://i.ibb.co/0RYBCCPp/imageedit-3-7315062423.png', sizes: '32x32', type: 'image/png' },
      { url: 'https://i.ibb.co/0RYBCCPp/imageedit-3-7315062423.png', sizes: '16x16', type: 'image/png' },
    ],
    apple: [
      { url: 'https://i.ibb.co/0RYBCCPp/imageedit-3-7315062423.png', sizes: '180x180', type: 'image/png' },
    ],
    other: [
      { url: 'https://i.ibb.co/0RYBCCPp/imageedit-3-7315062423.png', sizes: '192x192', type: 'image/png' },
      { url: 'https://i.ibb.co/0RYBCCPp/imageedit-3-7315062423.png', sizes: '512x512', type: 'image/png' },
    ],
  },
    ...
    <ClerkProvider
      ...
      <html lang="en" suppressHydrationWarning>
        <head>
          ...
          {/* Favicon - Using Imprintly Logo */}
          <link rel="icon" type="image/png" href="https://i.ibb.co/0RYBCCPp/imageedit-3-7315062423.png" />
          <link rel="shortcut icon" href="https://i.ibb.co/0RYBCCPp/imageedit-3-7315062423.png" />
          <link rel="apple-touch-icon" href="https://i.ibb.co/0RYBCCPp/imageedit-3-7315062423.png" />
