              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    value={customFormat}
                    onChange={(e) =>
                      setCustomFormat(e.target.value as 'png' | 'jpeg')
                    }
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-amber-500/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-amber-400 text-sm font-bold">I</span>
                </div>
                <div>
                  <h4 className="text-amber-300 font-semibold text-sm mb-1">
                    Elegant Watermark Included
                  </h4>
                  <p className="text-amber-200/80 text-xs leading-relaxed">
                    Your download will include a beautiful "Created with
                    Imprintly" watermark with our logo in elegant script fonts.
                    <span className="text-amber-300 font-medium">
                      {' '}
                      Upgrade to Pro
                    </span>{' '}
                    for completely clean downloads.
                  </p>
                </div>
              </div>
            </div>
