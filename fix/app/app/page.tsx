    ...
    <>
      ...
      {user && session && session.user && currentUser ? (
        <div className="flex flex-col h-screen">
          ...
          <Separator />
          {selectedImage ? (
            <div className="flex flex-col md:flex-row items-start justify-start gap-10 w-full h-[calc(100vh-8rem)] px-10 mt-2">
              <div className="flex flex-col items-start justify-start w-full md:w-1/2 gap-4">
                ...
                <div className="h-[60vh] max-h-[500px] w-[80%] p-4 border border-border rounded-lg relative overflow-hidden">
                  {isImageSetupDone ? (
                    <Image
                      src={selectedImage}
                      alt="Uploaded"
